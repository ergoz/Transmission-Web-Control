...
system.lang = {
	...
	,"dialog":{
		...
		,"system-config":{
			...
			,"download-queue-enabled":"Включить очередь загрузки, максимум загружаемых одновременно:"
			,"seed-queue-enabled":"Включить очередь отдачи, максимум отдаваемых одновременно:"
			...
			,"idle-seeding-limit-enabled":"Торренты на раздаче будут отключены если никто не качает:"
			,"minuets":"Минуты"
